export const FALLBACK_COURSES = [
  {
    ...
    isPublished: true,
    lessons: [
      { id: "seed-l1", title: "马和草原", coreThinking: "拆解力——再复杂的物体都能通过图形重组", sortOrder: 1, workflowType: "sketch-refine", image: "/works/sticker/img20250912_20082796.jpg", videoUrl: "/03-animal-stickers.mp4" },
      ...
      { id: "seed-l3", title: "从地心到星河", coreThinking: "色彩叙事力——认识从冷到暖、从地心到宇宙的色彩光谱", sortOrder: 3, workflowType: "color-compare", image: "/works/butterfly/img20251031_13551636.jpg", videoUrl: "/07-butterfly.mp4" },
      { id: "seed-l4", title: "虫虫的家", coreThinking: "导演思维——为角色设计一个完整的'家'空间", sortOrder: 4, workflowType: "spatial-factory", image: "/works/breakfast/1.jpg", videoUrl: "/05-collage.mp4" },
      { id: "seed-l5", title: "吃点什么", coreThinking: "逻辑链——从食材到成品，把烹饪逻辑转化成视觉画面", sortOrder: 5, workflowType: "style-transfer", image: "/works/breakfast/enen.jpg", videoUrl: "/02-breakfast.mp4" },
      ...
      { id: "seed-l7", title: "我设计的文字", coreThinking: "符号化能力——设计属于自己的文字符号系统", sortOrder: 7, workflowType: "sketch-refine", image: "/works/pattern/111.jpg", videoUrl: "/09-mask-design.mp4" },
      ...
      { id: "seed-l13", title: "图形的秘密", coreThinking: "图形概括——万事万物都可还原为基本图形", sortOrder: 13, workflowType: "sketch-refine", image: "/works/sticker/img20250912_20114460.jpg", videoUrl: "/01-materials.mp4" },
      { id: "seed-l14", title: "人体解构", coreThinking: "结构思维——用关节和比例解构复杂人体", sortOrder: 14, workflowType: "character-consistency", image: "/works/doll/img20251031_13473374.jpg", videoUrl: "/04-paper-doll.mp4" },
      ...
      { id: "seed-l17", title: "空间搭建", coreThinking: "透视入门——建立近大远小、前后遮挡的空间意识", sortOrder: 17, workflowType: "spatial-factory", image: "/works/pattern/img055.jpg", videoUrl: "/06-spatial-light.mp4" },
      ...
      { id: "seed-l19", title: "图案连续", coreThinking: "四方连续——理解重复、镜像、旋转的装饰规律", sortOrder: 19, workflowType: "tile-verify", image: "/works/pattern/吴若浠.jpg", videoUrl: "/08-pattern-repeat.mp4" },
